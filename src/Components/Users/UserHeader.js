                  ...
                  <div className='col-sm-5'></div>
                    <div className=' align-self-center'>
                        <ul className='d-inline-flex nav '>
                            <li className='p-2 nav-item'><Link to="/Users/Home" className='nav-link text-white'> <span > <img src={home} alt="home" width="18" height="17" /> Home</span></Link></li>
                            <li className='p-2 nav-item'><Link to="/Users/Shop" className='nav-link text-white'><span> <img src={medicine} alt="home" width="18" height="17" /> Shop</span></Link></li>
